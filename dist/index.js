...
function () {
  ...
  _createClass(Routes, [{
    key: "disableDefault",
    value: function disableDefault() {
      this.disableDefaultRoutes = true;
      return this;
    }
  }, {
    key: "withNamespace",
    value: function withNamespace(namespace) {
      var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

      if (this.namespace.value) {
        throw new Error("Namespace already registered as \"".concat(this.namespace, "\""));
      }
    ...
    value: function add(name, pattern, page) {
      ...
      var namespace = this.namespace.value;

      if (namespace) {
        var namespaceOptions = this.namespace.options;
        Object.keys(options).forEach(function (k) {
          if (options[k] && namespaceOptions[k]) {
            options[k] = "".concat(namespace, "/").concat(options[k]);
          }
        });
      }
